...
export default function AccordionUsagetuning() {
  return (
    <LeftmenusContainer className='leftmenu_wrap_con'>
      ...
      <div className='But_wrap'><Link to={"/tuningmodeles"} style={{height:'0px'}}><button className='BTN_Wrap'>compare</button></Link></div>
