...
import { CartCon, CartConWraper } from './used_car_carts';
import Slider from 'react-slick';

 
const Used_car_CarteComponen = () => { //datail_name
const { id } = useParams();
const datail_cons = usedcarCar.usedCon

const datail_names = datail_cons.filter((value) => value.id === parseInt(id));
console.log(datail_names);
    const datai =  usedcarCar.usedCon
...
export default Used_car_CarteComponen
