...
const Datailmotor = () => {
  ...
  return (
    ...
    <DatailCon>
      ...
      return(
        <div key={index}>
          ...
          <div className='right-info'>
            ...
            <h5>Aid</h5>
            <hr className='lang'/>
           <div className='info'><h4>Company</h4><h4>{value.car.company}</h4></div>
           <div className='info'><h1>People</h1><h4>{value.car.place}</h4></div>
           <div className='info'><h6>License type</h6><h4>{value.car.license}</h4></div>
           </div>
        </DatailMenu>
        </div>
     )})}
     ...
     <div className='ComfrtWrap'>
     <div className='lorem'><h2>Tidying away is child's play!</h2>
     <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Rutrum nibh urna sagittis arcu natoque lectus cursus felis. Nec, felis risus, id in proin sed proin iaculis mi. Turpis ac ut metus, amet, pulvinar. Eget amet dictum luctus quis molestie tellus vitae.Lorem ipsum dolor sit amet, consectetur adipiscing elit. Rutrum nibh urna sagittis arcu natoque lectus cursus felis. Nec, felis risus, id in proin sed proin iaculis mi.</p></div>
     </div>
     </ImgWrapCon>
     ...
     <ImgWrapCon  className='ImgWrapCon'>
     <div className='ComfrtWrap'>
     <div className='lorem'><h2>Ventilated, Lit up</h2>
...
Camper relies on legendary Seitz windows. They offer the best insulation and are also the easiest to use and safest because they can’t be removed from the outside. </p>
</div>
     </div>
     <div className='imgWrap'>
     ...
     <div className='ComfrtWrap'>
     <div className='lorem'><h2>Easy access</h2>
...
All our vans are equipped with an electric step.</p></div>
     </div>
     </ImgWrapCon>

     <ImgWrapCon  className='ImgWrapCon'>
     <div className='ComfrtWrap'>
      <div className='lorem'><h2>Heating when driving</h2>
