...
import { CartCon, CartConWraper } from './tuningcarts';
import Slider from 'react-slick';
import { tuningCar } from '../mock/tuningdata';

 
const TuningCarteComponen = () => { //datail_name
const { id } = useParams();
const datail_cons = tuningCar.tuningCon

const datail_names = datail_cons.filter((value) => value.id === parseInt(id));
console.log(datail_names);
    const datai = tuningCar.tuningCon
...
export default TuningCarteComponen