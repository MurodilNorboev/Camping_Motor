...
import UsedQ_a from './ude_car_q&a';
import UsedFaq from './used_car_faq';
import UsedContact from './used_car_contact';
import { Itm_Wrap, ItomCon } from './used_car_tabss';

export default function Used_carTabs() {
    const datailtabs = usedcarCar.usedCon
  ...
  return (
    <Box sx={{ width: '100%', typography: 'body1' }}>
      <TabContext value={value}>
        ...
        <TabPanel value="2"><UsedQ_a /></TabPanel>
        <TabPanel value="3"><UsedFaq /></TabPanel>
        <TabPanel value="4"><UsedContact /></TabPanel>
      </TabContext>
    </Box>
  );
}